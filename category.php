...
?>
            <tr>
                ...
                <td>
                    <button class='btn btn-warning btn-sm' data-toggle='collapse' data-target='#updateForm<?php echo $row['cat_id'] ?>'>Update</button>
                    <div id='updateForm<?php echo $row['cat_id'] ?>' class='collapse mt-2'>
                        <form action='update_category.php' method='post'>
                            <input type='hidden' name='id' value='<?php echo $row['cat_id'] ?>'>
                            <div class='form-group'>
                                <label for='update_category'>Category:</label>
                                <input type='text' id='update_category' name='update_category' class='form-control' value='<?php echo $row['category'] ?>' required>
                            </div>
                ...
                <td class="del">
                    <a class="btn btn-danger" onclick="return checkdelete()" href="delete_catagories.php?id=<?php echo $row['cat_id'] ?>">
